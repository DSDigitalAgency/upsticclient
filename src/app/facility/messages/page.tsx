  ...
  const conversations = [
    {
      ...
      lastMessage: {
        text: "Thank you for considering my application. I'm available for an interview this week.",
        timestamp: "5m ago",
        unread: true,
      },
    ...
    },
    {
      ...
      lastMessage: {
        text: "I have reviewed the offer letter and would like to discuss a few points.",
        timestamp: "2h ago",
        unread: false,
      },
    ...
    },
    {
      ...
      lastMessage: {
        text: "Could you provide more information about the night shift schedule?",
        timestamp: "1d ago",
        unread: false,
      },
                  ...
                  <div className="relative">
                    <div className="h-12 w-12 rounded-full bg-gray-200 flex items-center justify-center">
                      <span className="text-lg font-medium text-gray-600">
                        {conversation.candidate.name[0]}
                      </span>
                    </div>
                    {conversation.candidate.online && (
          ...
          <div className="p-4 border-b border-gray-200 bg-white">
            <div className="flex items-center space-x-4">
              ...
              <div>
                ...
                <p className="text-sm text-gray-500">Senior Registered Nurse</p>
              </div>
            </div>
          </div>
            ...
            <div className="space-y-4">
              ...
              <div className="flex">
                <div className="bg-white text-gray-900 rounded-lg px-4 py-2 max-w-md shadow-sm">
                  <p className="text-sm">
                    Thank you for considering my application. I'm available for
